...
<input name="search" type="text" placeholder="What do you need?" style=" color: black; margin-left: -3.5px; width: 500px; margin-top: 13px;height: 48px; font-size: 19px; opacity: 10;" >
   ...
   <%   int sed=0;
        ...
        String a1 = request.getParameter("name");
            ...
            String a3 = request.getParameter("company");
            String a4 = request.getParameter("sector");
            String a5 = request.getParameter("email");
            String a6 = request.getParameter("uname");
            String a7 = request.getParameter("psw");
            String a8 = request.getParameter("address1");
            String a9 = request.getParameter("address2");
            String a10 = request.getParameter("city");
            String a11 = request.getParameter("pincode");
            String a12 = request.getParameter("phone");
            String a13 = request.getParameter("CTIN");
   ...
   //out.print(a1);out.print(a2);out.print(a3);out.print(a4);out.print(a5);out.print(a6);out.print(a7);out.print(a8);
         // out.print(a9);out.print(a10);out.print(a11);out.print(a12);out.print(a13);out.print(sector);out.print(sec);
      try{
          int s = 12345;
          s=sed;
          //sec = sec;
    ...
    <div class="register-login-section spad"  style=" margin-left: 300px; width: 80%; ">
        <div class="container" style=" " > 
            <div class="row" >
                <div class="col-lg-6 offset-lg-3" style=" margin-top: -60px; background-color: whitesmoke; width: 60%; height: 700px;   " >
                    <div class="register-form" style=" ">
                        <br>
                       
                             <div class="group-input">
                                <label for="name">Full name *</label>
                                <input type="text" name="name" id="name" style=" width: 150px;" placeholder="<%=a1%>" readonly="readonly">
                                <label for="desig" style=" margin-left: 100px;  margin-top: -86px;">Designation*</label>
                                
                                <input type="text" name="designation" id="desig" style=" width: 228px; margin-top: 0px; " placeholder="<%=a2%>"readonly="readonly" >
                            </div>
                            <br>
                            <div class="group-input">
                                <label for="indust">Industry/Organization name*</label>
                                <input type="text" name="company" id="indust" style=" width: 300px; margin-left: 152px;" placeholder="<%=a3%>"readonly="readonly">
                                <br><label for="desig" style=" margin-left: 0px; margin-top: 20px;">Sector*</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 295px; " placeholder="<%=sector%>"readonly="readonly" >
                            </div>
                            <br>
                            <div class="group-input">
                                <label for="email">Official E-mail *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 240px; " placeholder="<%=a5%>"readonly="readonly" >
                                <br><label for="username"  style=" margin-left: 0px; margin-top: 20px;">Username*</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 270px; " placeholder="<%=a6%>"readonly="readonly" >  
                            </div>
                            <br>
                             <div class="group-input">
                                <label for="phone">Phone number *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 238px; " placeholder="<%=a12%>"readonly="readonly" > 
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">CTI Number*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 258px; " placeholder="<%=a5%>"readonly="readonly" >
                                
                                                                 
                            </div>
                            <div class="group-input">
                                <br><label for="phone">Address line 1 *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 238px; " placeholder="<%=a8%>"readonly="readonly" > 
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Address line 2*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 240px; " placeholder="<%=a9%>"readonly="readonly" >
                                
                                                                 
                            </div>
                            <div class="group-input">
                                <br><label for="phone">City *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 305px; " placeholder="<%=a10%>"readonly="readonly" > 
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Pin-code*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 275px; " placeholder="<%=a11%>"readonly="readonly" >
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Password*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 275px; " placeholder="<%=a7%>"readonly="readonly" >
