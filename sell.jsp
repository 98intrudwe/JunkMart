...
<input name="search" type="text" placeholder="What do you need?" style=" color: black; margin-left: -3.5px; width: 500px; margin-top: 13px;height: 48px; font-size: 19px; opacity: 10;" >
    ...
    <div class="container-fluid" style=" margin-left: 350px; width: 100%; margin-top: 50px;"> 
    ...
    <div class="row justify-content-center"> 
        ...
        <div class="col-11 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2"> 
            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3"> 
                <form id="msform" action="sell2.jsp" method="post">
                <i style=" font-size: 60px; color:#009966;" class=" fa fa-money"> </i><h2 style=" color: #009966;" id="heading">CASH FOR TRASH</h2>
                <p>Fill all form field to go to next step</p>
                
                    <!-- progressbar -->
                    <ul id="progressbar">
                        <li class="active" id="account"><strong>Seller Info</strong></li>
                        <li id="personal"><strong>Waste Info</strong></li>
                    ...
                    <fieldset>
                        ...
                        <div class="form-card">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="fs-title">Seller Information:</h2>
                                </div>
                                <div class="col-5">
                            ...
                            <label class="fieldlabels">Full Name/Company Name: *</label> 
                            <input type="text" name="company" placeholder="Eg: Stark Enterprises" /> 
                            <label class="fieldlabels">Username: *</label>
                            <input type="text" name="uname" placeholder="user name" /> 
                            <label class="fieldlabels">Phone no: *</label> 
                            <input type="text" name="phone" placeholder="+91-9821053975 " />
                            <label class="fieldlabels">City: *</label> 
                            <label class="fieldlabels" style=" margin-left: 272px;">Pin-code: *</label> <br>
                            
                            <input style=" width:280px; " type="text" name="city" placeholder="eg: Pune" />
                             <input style=" width:300px; margin-left: 40px; " type="text" name="pincode" placeholder="eg: 411014" />
                             <label class="fieldlabels" style=" margin-left: 0px;">CTIN(if applicable): *</label> <br>
                            
                            <input style=" width:280px; " type="text" name="CTIN" placeholder="eg:39343" />
                      
                                <div class="" style="width:300px; margin-left: 330px; margin-top: -90px; ">
                                    <label class="fieldlabels" for="sector" style=" margin-left:0px; margin-top: 0x; font-size: 16px;">Sector*</label>
                                    <select name="sector" style=" width: 296px; height: 30px; border: 1px solid black; color:black; background-color: #ddd; ">
                            ...
                            <input type="text" name="add1" placeholder="Eg: Plot 402, Shivaji nagarr" /> 
                            <label class="fieldlabels">Address line 2: *</label>
                            <input type="text" name="add2" placeholder="Eg: Plot 402, Shivaji nagarr" /> 
                             <label class="fieldlabels">State: *</label>
                            <input type="text" name="state" placeholder="Eg: Maharashtra" /> 
                             <label class="fieldlabels">Password: *</label>
                            <input type="password" name="password" placeholder="" /> 
                        </div> <input style=" background-color: #009966;" type="button" name="next" class="next action-button" value="Next" />
                    </fieldset>
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="fs-title">Waste Information:</h2>
                                </div>
                                <div class="col-5">
                                    <h2 class="steps">Step 2 - 4</h2>
                                </div>
                            </div> <label class="fieldlabels">Type of waste: *</label> 
                            <br> 
                            <select name="wtype" class="select-css" >
                             ...
                             <br><label class="fieldlabels">Product name: *</label> <input type="text" name="pname" placeholder="Eg: HDPE Plastic Bottles" /> 
                            <br><label class="fieldlabels">Description: *</label> <input type="text" name="des" placeholder="Eg: HDPE material plastic bottles used widely in industry" /> 
                            <label class="fieldlabels">Quantity.: *</label> <label style=" margin-left: 213px;" class="fieldlabels">Units: *</label><br>
                            <input type="number" id="quantity" name="quantity" min="1" max="100000" style=" width: 200px;"> 
                            <select name="units" class="select-css" style=" width: 200px; margin-left: 300px; margin-top: -65px;" >
                                <option value="0" selected="">Select one</option>      
                            ...
                            <br><label class="fieldlabels">Source of Waste: *</label> <input type="text" name="source" placeholder="Eg: Used in Packaging" />
                        </div> <input style=" background-color: #009966;" type="button" name="next" class="next action-button" value="Next" /> <input  type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                            ...
                            </div> <label class="fieldlabels">Upload Waste Photo:</label> <input type="file" name="pic" accept="image/*"> 
                        </div> <input style=" background-color: #009966;" type="button" name="next" class="next action-button" value="Next" /> <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    <fieldset>
                        <div class="form-card">
                            ...
                            <h2  style=" font-size: 20px; padding: 14px; width: 460px; background-color: #ccc;" ><strong>Waste Category: </strong> Plastics</h2> <br>
                            <br><h2 style=" font-size: 20px; padding: 14px; width: 460px; background-color: #ccc;" ><strong>Waste Sub-Category: </strong> Bottles</h2> <br><br>
                            <div class="row justify-content-center">
                                <div class="col-7 text-center">
                                    <h5 class="purple-text text-center">Result Brought to you by CNN</h5>
                                </div>
                            </div>
                        </div> <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                        <button 
                            style="width:100px; height: 40px; margin-left: -420px; margin-top: 10px;
                            color: white; background-color: #009966; border: none; " type="submit">SUBMIT</button>
                    </fieldset>
