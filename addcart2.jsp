...
<!--    <ul class="tableHead">
    ...
    <ul class="cartWrap">
        ...
        <li class="items odd">
            <form action="addcart0.jsp?+<%=p1%>" method="post">
    <div class="infoWrap"> 
        ...
        <img src="<%=image%>" alt="" class="itemImg" />
          ...
          <input value="3" id="q1" name="q1" style=" font-size: 14px; width: 80px;" type="number" min="1" max="5"  class="qty" placeholder="<%=units%>"/> <p style=" font-size: 13px;"> x </p>   
          <p style=" margin-left: 5px; font-size: 13px;"> ₹ </p><input value="<%=price%>" id="q2" name="q2" style=" font-size: 12px; width: 50px;" type="number"   disabled="true" placeholder="<%=units%>"/>
        ...
        <div class="prodTotal cartSection">
         ...
         <button  style=" margin-top: -20px; margin-left: 00px; border: none; background-color: #009966; color: white;">ADD +</button>
         </form>
         <button style=" margin-top: -40px; margin-left: 800px; width: 100px;  background-color: #009966; color:white; opacity:2; border: outset #333333;" onclick="myFunction()">Compute</button>
      </li>
...
<div style=" left: 400px;"  >
    ...
    <input type="number" disabled="true" style=" display: none;  color: white; margin-left: 560px; margin-top: -41px;" value="<%=y%>" id="tot"/>
        </div>
      <%  sub2 = y +total2 ;  
            %>
