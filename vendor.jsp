            ...
            <div class="row" >
                <div class="col-lg-6 offset-lg-3" style=" margin-top: -60px; background-color: whitesmoke;   " >
                    <div class="register-form" style=" ">
                        <h2 style=" color: #009966; font-size: 24px;" ><i class=" fa fa-user "></i>  SIGN UP<br>LOCAL SCRAP VENDORS</h2>
                        <form action="vendor2.jsp" method="POST">
                            ...
                            <div class="group-input">
                                <label for= "work" style=" ">Currently working as vendor?*</label>
                                <div class="wok">
                            ...
                            <div class="group-input">
                            <label for="wtype">What type of waste <br>do you collect? *</label>
                             
                                 <select  name="wtype" id="wtype" style=" margin-left: 10px; height: 30px; width: 100px; border: 1px solid black; color:black; background-color: #ddd; ">
                                 ...
                                 <label for="exp" style=" margin-top:-105px; margin-left: 320px;">Maximum capacity <br>for waste collection(kg) *</label>
