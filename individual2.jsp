<%-- 
    Document   : individual2
    Created on : 27 Jul, 2020, 3:02:52 AM
    Author     : Kaizen
--%>
 ...
 <%
     int sed=0;
        ...
        String a1 = request.getParameter("name");
            ...
            String a3 = request.getParameter("username");
            String a4 = request.getParameter("phone");
            String a5 = request.getParameter("gender");
            String a6 = request.getParameter("add1");
            String a7 = request.getParameter("add2");
            String a8 = request.getParameter("password");
            
            String a9 = request.getParameter("city");
            String a10 = request.getParameter("pincode");
           
           
           if(a5.equalsIgnoreCase("male")==true){
               sed=0;
           }else if(a5.equalsIgnoreCase("female")==true){
               sed=1;
           }
    ...
    <div class="register-login-section spad"  style=" margin-left: 300px; width: 80%; ">
        <div class="container" style=" " > 
            <div class="row" >
                <div class="col-lg-6 offset-lg-3" style=" margin-top: -60px; background-color: whitesmoke; width: 60%; height: 600px;   " >
                    <div class="register-form" style=" ">
                        <br>
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 290px; " placeholder="<%=a2%>"readonly="readonly" >
                                <br><label for="username"  style=" margin-left: 0px; margin-top: 20px;">Username*</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 270px; " placeholder="<%=a3%>"readonly="readonly" >  
                            </div>
                            <br>
                             <div class="group-input">
                                <label for="phone">Phone number *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 238px; " placeholder="<%=a4%>"readonly="readonly" > 
                              <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Gender*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 290px; " placeholder="<%=a5%>"readonly="readonly" >
                                
                                                                 
                            </div>
                            <div class="group-input">
                                <br><label for="phone">Address line 1 *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 238px; " placeholder="<%=a6%>"readonly="readonly" > 
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Address line 2*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 240px; " placeholder="<%=a7%>"readonly="readonly" >
                                
                                                                 
                            </div>
                            <div class="group-input">
                                <br><label for="phone">City *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 305px; " placeholder="<%=a9%>"readonly="readonly" > 
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Pin-code*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 275px; " placeholder="<%=a10%>"readonly="readonly" >
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Password*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 268px; " placeholder="<%=a8%>"readonly="readonly" >
