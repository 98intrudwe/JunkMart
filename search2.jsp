...
<input name="search" type="text" placeholder="What do you need?" style=" color: black; margin-left: -3.5px; width: 500px; margin-top: 13px;height: 48px; font-size: 19px; opacity: 10;" >
    ...
    %>
    <br><br> <h2 style=" color: whitesmoke;; margin-left: 70px; background-color: #009966; text-align: center; width: 89%;"><b>Search Results for "<%=p1%>"</b> </h2><br>
  ...
  acc[i].addEventListener("click", function() {
	...
	font-weight: 700; text-align: center; color: white; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;padding: 8px; width:115%; ">
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    ...
                    String query = "select * from products where  product_name like '%"+p1+"%' or product_description like '%"+p1+"%' or product_category like '%"+p1+"%'  or product_subcategory like '%"+p1+"% ; '" ;
