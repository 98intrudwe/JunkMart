<%-- 
    Document   : product
    Created on : 28 Jul, 2020, 11:50:26 PM
    Author     : Kaizen
--%>
                        ...
                        <li><a href="#">Join Us</a>
                            <ul class="dropdown">
                               <li><a href="vendor.jsp">Junk Vendor</a></li>
                                ...
                                <li><a href="sell.html">Supplier</a></li>
...
function magnify(imgID, zoom) {
 ...
 <%
                    ...
                    st.setString(1, p1);
                   //int o=2; int a1=1; int a2=2; int a3=3;
...
<div class="col-lg-6" style=" margin-left:  650px; margin-top: -650px;">
                            <div class="product-details">
                                ...
                                <div class="pd-desc">
                                    <p style=" font-size: 16px; width: 80%;"><%=description%>  
                                        </p>
                                    <h4 style=" color: #009966;">₹35.00 <span>₹<%=price%></span></h4>
                                </div>
                                <h6 style=" font-size: 20px;"><b>Quantity(<%=units%>)</b></h6> 
                                <div class="quantity" style=" margin-top: 15px;">
                                    
                                    <div class="pro-qty">
                                        <input type="text" value="1">
                                    </div>
                                    <a href="#" class="primary-btn pd-cart" style=" background-color:#009966; ">Add To Cart</a>
                                </div>
                                <ul class="pd-tags" style=" margin-top: -30px;">
                                 ...
                                 while(rs.next()){
                                    String sname=rs.getString("comapny_name");
                                ...
                                <div class="pd-share" style=" margin-top: -30px">
                                    <div class="p-code">Sold by: <a href="#"><%=sname%></a> </div>
...
<div class="" style=" background-color: #009966;  width: 85%; margin-left: 233px; margin-top:50px; color: white; align-content: center; text-align: center; ">
...
<div id="London" class="w3-container city" style=" height: 60%; margin-left: 235px; position: absolute; margin-top: 2px; background-color: whitesmoke; width: 77%; ">
    <br> <h5>Description by the Seller</h5>
                                                ...
                                                <img src="images/Productline/Plastics/LDPE.png" alt="" width="250" height="250" style=" margin-left: 600px; margin-top: -160px">
</div>
...
<div id="Paris" class="w3-container city" style=" height: 60%; margin-left: 235px; position: absolute; margin-top: 2px; background-color: whitesmoke; width: 77%; ">
    <br><h5><%=sname%> PVT. LTD.</h5>
                                                <p><%=sname%> Retail Private Ltd is committed to providing each customer with the highest standard of customer service.</p>
                                                   <ul style=" margin-left: 20px; font-size: 18px;">
                                                       <li><b>Seller Name:</b> <%=sname%> Corporation </li>
                                                     <li><b>Seller Address:</b> <p><%=add1%> <br> <%=add2%><br><%=city%><br><%=pin%><br><%=state%> </p> </li>
                                                     <li> <b>CIN:</b><%=CTIN%> </li>
                                                      <li> <b>Phone:</b><%=phone%> </li>
                                                      <li> <b>Products sold:</b> Plastics, E-Waste, Paper</li>
                                                </ul>
                                                <img src="images/Productline/Plastics/LDPE.png" alt="" width="250" height="250" style=" margin-left: 600px; margin-top: -100px">
</div>
<%
