<%-- 
    Document   : individual
    Created on : 27 Jul, 2020, 3:03:34 AM
    Author     : Kaizen
--%>
            ...
            <div class="row" >
                <div class="col-lg-6 offset-lg-3" style=" margin-top: -60px; background-color: whitesmoke;   " >
                    <div class="register-form" style=" ">
                        <h2 style=" color: #009966;"><i class=" fa fa-user "></i>  SIGN UP</h2>
                        <form action="individual2.jsp">
                            ...
                            <div class="group-input">
                                ...
                                <input type="text"  name="username" id="username" style=" width: 228px; margin-left: 330px; margin-top: 0px;">
                            </div>
                             <div class="group-input">
                                <label  for="phone">Phone number *</label>
                                <input name="phone" type="text" id="phone" style=" width: 300px; ">
                                <label for= "gender" style=" margin-left: 332px; margin-top: -86px;">Gender*</label>
                                <div class="gend">
                                    <input type="radio" id="male" name="gender" value="male"  style=" margin-left: 330px;">
                                    <label for= "male" style=" margin-left: 350px; margin-top:-42px; ">Male</label>
                                    <input type="radio" id="female" name="gender" value="female"  style=" margin-left: 400px; margin-top:-48px; position: absolute; ">
                                    <label for= "female" style=" margin-left: 420px; margin-top:-38px; position: absolute; ">Female</label>
                                </div>
                                                                 
                            </div>
                            <div class="group-input">
                                <label for="add">Address line 1 *</label>
                                <input type="text" id="add" name="add1" >
                            ...
                            <div class="group-input">
                                ...
                                <label for= "pincode" style=" margin-left: 330px; margin-top: -86px;">Pin-code *</label>
                                <input style=" margin-left: 330px; width: 225px;" name="pincode" type="text" id="pincode" >
