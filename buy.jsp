...
<input name="search" type="text" placeholder="What do you need?" style=" color: black; margin-left: -3.5px; width: 500px; margin-top: 13px;height: 48px; font-size: 19px; opacity: 10;" >
    ...
    <section class="product-shop spad" style=" margin-top: -30px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                                <div class="product-item" style=" border:1px solid #cccccc; padding-left:10px; padding-right: 10px;padding-top: 5px;">
                                    <div class="pi-pic" >
                                        ...
                                        <ul>
                                            <li class="w-icon active" style=" background-color:  #009966;">
                                                <a href="addcart.jsp?+<%=pid1%>" style=" background-color:  #009966;"><i class="fa fa-shopping-cart" style=" background-color:  #009966;"></i></a></li>
                                            <li class="quick-view" style=" background-color:  #009966;">
                                                <a href="products.jsp?+<%=pid1%>" style=" background-color:  #009966; color: white;">+ Quick View</a></li>
                    ...
                    float f21 = rs.getFloat("price_rate");
                                ...
                                <div class="product-item" style=" border:1px solid #cccccc; padding-left:10px; padding-right: 10px;padding-top: 5px;">
                                    <div class="pi-pic" >
                                        ...
                                        <ul>
                                            <li class="w-icon active" style=" background-color:  #009966;">
                                                <a href="addcart.jsp?+<%=pid2%>" style=" background-color:  #009966;"><i class="fa fa-shopping-cart" style=" background-color:  #009966;"></i></a></li>
                                            <li class="quick-view" style=" background-color:  #009966;">
                    ...
                    float f31 = rs.getFloat("price_rate");
                                ...
                                <div class="product-item" style=" border:1px solid #cccccc; padding-left:10px; padding-right: 10px;padding-top: 5px;">
                                    <div class="pi-pic" >
                                        ...
                                        <ul>
                                            <li class="w-icon active" style=" background-color:  #009966;">
                                                <a href="addcart.jsp?+<%=pid3%>" style=" background-color:  #009966;"><i class="fa fa-shopping-cart" style=" background-color:  #009966;"></i></a></li>
                                            <li class="quick-view" style=" background-color:  #009966;">
