        ...
        //String username = (String)session.getAttribute("uname");
          ...
          try {
                   ...
                   float rate=0;
                    ...
                    float xf = xc*rate; int f=1;
                    String add = "insert into cart_items values(?,?,?,?,?,?,?,?);";
                    st = (PreparedStatement)con.prepareStatement(add);
     ...
     if(flag==1){
              ...
              Class.forName("com.mysql.jdbc.Driver");
                   ...
                   int o=2; float g=o;  int d=4;
                    ...
                    PreparedStatement  st = (PreparedStatement) con.prepareStatement(query4);
                    st.setInt(1, oid);
                     ResultSet rs = st.executeQuery();
                    float total1=0;
                    while(rs.next()){
