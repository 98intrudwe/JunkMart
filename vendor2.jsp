...
<input name="search" type="text" placeholder="What do you need?" style=" color: black; margin-left: -3.5px; width: 500px; margin-top: 13px;height: 48px; font-size: 19px; opacity: 10;" >
    ...
    <%
        ...
        String a1 = request.getParameter("name");
            ...
            String a5 = request.getParameter("work");
            String a6 = request.getParameter("pincode");
            String a7 = request.getParameter("city");
            String a8 = request.getParameter("state");
            
            String a9 = request.getParameter("add1");
            String a10 = request.getParameter("add2");
            String a11 = request.getParameter("hours");
           String a12 = request.getParameter("experience");
           String a13 = request.getParameter("wtype");
           String a14 = request.getParameter("capacity");
           String cap =a14.concat("kg");
           if(a5.equalsIgnoreCase("yes")==true){
               sed=1;
           }else if(a5.equalsIgnoreCase("no")==true){
               sed=0;
           }
                    ...
                    <div class="register-form" style=" ">
                        <br>
                             ...
                             <div class="group-input">
                                ...
                                <input type="text" name="name" id="name" style=" width: 300px; margin-left: 270px;" placeholder="<%=a1%>" readonly="readonly">
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 290px; " placeholder="<%=a4%>"readonly="readonly" >
                                <br><label for="username"  style=" margin-left: 0px; margin-top: 20px;">Username*</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 270px; " placeholder="<%=a2%>"readonly="readonly" >  
                            </div>
                            <br>
                             <div class="group-input">
                              ...
                              <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Currently working as vendor? *</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 140px; " placeholder="<%=a5%>"readonly="readonly" >
                                
                                                                 
                            </div>
                            <div class="group-input">
                                <br><label for="phone">Address line 1 *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 238px; " placeholder="<%=a9%>"readonly="readonly" > 
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Address line 2*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 240px; " placeholder="<%=a10%>"readonly="readonly" >
                                
                                                                 
                            </div>
                            <div class="group-input">
                                <br><label for="phone">City *</label>
                                <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 305px; " placeholder="<%=a7%>"readonly="readonly" >
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Locality*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 282px; " placeholder="<%=a8%>"readonly="readonly" >
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Pin-code*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 275px; " placeholder="<%=a6%>"readonly="readonly" >
                               ...
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 260px; " placeholder="<%=a12%>"readonly="readonly" >
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Servicable hours*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 220px; " placeholder="<%=a11%>"readonly="readonly" >
                                <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Type of waste collected*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 175px; " placeholder="<%=a13%>"readonly="readonly" >
                                 <br><label for= "ngo" style=" margin-left: 0px; margin-top: 20px;">Password*</label>
                               <input type="text" name="designation" id="desig" style=" width: 300px; margin-top: 0px; margin-left: 265px; " placeholder="<%=a3%>"readonly="readonly" >
